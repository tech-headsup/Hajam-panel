...
const PrevIcon = ({ icon, rounded, outline, className }) => (
  <div
    className={cn(
      iconStyles.base,
...
const NextIcon = ({ icon, rounded, outline, className }) => (
  <div
    className={cn(
      iconStyles.base,
      outline ? iconStyles.outline : iconStyles.center,
...
const JumpPrevIcon = ({ icon, rounded, outline, className }) => (
  <div
    className={cn(
      iconStyles.base,
      outline ? iconStyles.outline : iconStyles.center,
...
const JumpNextIcon = ({ icon, rounded, outline, className }) => (
  <div
    className={cn(
      iconStyles.base,
      outline ? iconStyles.outline : iconStyles.center,
...
export default function MonPagination({
  outline = false,
  rounded = "md",
  variant = "solid",
  color = "primary",
...
MonPagination.displayName = "Pagination";
